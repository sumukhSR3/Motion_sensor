...
class MotionDetector():
    def __init__(
        ...
        if not ret:
            raise RuntimeError("Failed to read from the camera. Please check the camera connection and index.")
    ...
    def add_info(self):
        ...
        Add bounding box around movement if annotate parameter is True
        '''
    ...
    def initialize_recorder(self):
        ...
        '''
        folder = 'videos/'+datetime.now().strftime('%H-%M-%S-%A%d%B%Y')+'/'
